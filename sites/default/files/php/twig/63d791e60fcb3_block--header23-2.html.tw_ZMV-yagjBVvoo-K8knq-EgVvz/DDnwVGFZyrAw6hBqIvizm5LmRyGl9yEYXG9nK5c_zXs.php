...
class __TwigTemplate_8d1a96b989faa3380e8104b62a44accc077ebdbf4b7d5af69ba72b066cfc69be extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t\t<li id=\"search-btn\"><a ><i class=\"fa-solid fa-magnifying-glass\"></i></a></li>

\t\t\t\t\t\t\t\t<li id=\"user-account\"><a href=\"/E-kart/user/login\"><i class=\"fa-solid fa-circle-user\"></i></a></li>

\t\t\t\t\t\t\t\t<li id=\"cart-btn\"><a href=\"/E-kart/cart\"  target=\"_blank\"><i class=\"fa-solid fa-cart-shopping\"></i></a></li>
\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
