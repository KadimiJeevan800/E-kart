...
;
console.log("Hello Form slide");

(function ($, Drupal) {

    'use strict';
  
    Drupal.behaviors.menusliding = {
      attach: function (context, settings) {
        
        //Toggle Effect for mobile version menu
        $(context).find("#toggle").once("#mobile-v").each(function () {
        ...
        $(context).find("#search-btn").once("some-arbitrary-key").each(function () {

              
          $("#search").hide();
          $( once("#search-btn",context)).click(function(){
