...
function myFunction() {
  ...
  {
    document.getElementById("mobile-v").classList.display="block";
    // alert("Clicked event");
    if(flag==0)
    {
      ...
      document.getElementById("mobilev").style.overflow="hidden";
      document.getElementById("mobilev").style.transition="height 1s";
      document.getElementById("mobilev").style.height="474px";
    ...
    {
      document.getElementById("mobilev").style.transition="height 1s";
      document.getElementById("mobilev").style.height="0px";
      // document.getElementById("mobile-v").style.display="none";
