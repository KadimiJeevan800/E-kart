  ...
  function() {
    ...
    else
    {
      ...
      if (panel.style.display === "block") {
        ...
        document.getElementById("mobile-v").style.height="475px";
        document.getElementById("arrow").style.transition="height 0.2s";
        document.getElementById("mobile-v").style.transform= "rotate(360deg)";
      } else {
        panel.style.display = "block";
        document.getElementById("mobile-v").style.transition="height 0.2s";
        document.getElementById("mobile-v").style.transform= "rotate(90deg)";
      }
    }
